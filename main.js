...
`<div style="padding:24px;font-family:-apple-system,sans-serif;color:#fff;background:#08090c;min-height:100vh;"> <h2 style="margin:0 0 12px;">Intent — erreur de chargement</h2> <p style="opacity:.7;margin:0 0 12px;">Un fichier script est manquant ou contient une erreur.</p> <pre style="white-space:pre-wrap;background:rgba(255,255,255,.06);padding:14px;border-radius:12px;font-size:13px;">${String(e)}</pre> </div>`;
}
})();